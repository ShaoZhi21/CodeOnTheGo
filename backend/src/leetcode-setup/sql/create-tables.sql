...
-- Create user recent topics table
...
-- Create index for efficient querying of recent topics
CREATE INDEX IF NOT EXISTS idx_user_recent_topics_user_visit 
ON user_recent_topics(user_id, visit_order);
