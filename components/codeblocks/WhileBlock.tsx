...
export function WhileBlock({ condition, body, onChangeCondition, onChangeBody, onDelete, borderStyle, explanation }: WhileBlockProps) {
  return (
    <View style={{ marginBottom: 8 }}>
      <View style={[styles.container, borderStyle]}>
        <View style={styles.row}>
          <ThemedText style={styles.label}>while</ThemedText>
          <TextInput
