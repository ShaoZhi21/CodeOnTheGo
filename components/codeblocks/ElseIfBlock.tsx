...
export function ElseIfBlock({ condition, body, onChangeCondition, onChangeBody, onDelete, isConnected, borderStyle, explanation }: ElseIfBlockProps) {
  return (
    <View style={{ marginBottom: 8 }}>
      <View style={[styles.container, isConnected && styles.connectedContainer, borderStyle]}>
